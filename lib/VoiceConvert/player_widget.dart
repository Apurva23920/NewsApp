...
import 'package:News/VoiceConvert/voice_convertion.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        IconButton(icon: _isPlaying? Icon(Icons.pause): Icon(Icons.play_arrow),
         onPressed: (){_isPlaying ? _pause() : _play(body);
         }
         ),
      ],
    );
...
await file.writeAsBytes(bytes);
    ...
    final playPosition = (_position != null &&
        ...
        ? _position
        : null;
    final result = await _audioPlayer.play(file.path,position: playPosition);
